...
<h2 style="font-size: 2.5rem; font-weight: bold; margin: 2rem 0 1rem 0;">Conceptual Statement</h2>
...
<h2 style="font-size: 2.5rem; font-weight: bold; margin: 2rem 0 1rem 0;">Action Strategy</h2>
...
<div style="display: grid; grid-template-columns: 2fr 1fr; gap: 2rem; margin: 1.5rem 0; align-items: start;">
    <div>
        ...
        <p>A soft cushion is transformed into a hostile object using metal wire, mimicking the logic of anti-homeless and anti-pigeon spikes.</p>
...
<h3 style="font-size: 1.8rem; font-weight: bold; margin: 1.5rem 0 0.5rem 0;">Why this strategy</h3>
<p>The two phases create a narrative arc:</p>
<ul style="margin: 1rem 0 1.5rem 0;">
     <li><strong>Humans</strong> experience discomfort when hostility affects something meant to be soft.</li>
     <li><strong>Pigeons</strong> reveal the deeper impact of exclusion through their absence, hesitation, or refusal to return.</li>
</ul>
...
<h2 style="font-size: 2.5rem; font-weight: bold; margin: 2rem 0 1rem 0;">Activation of an Affective Relationship with the Collective</h2>

<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin: 2rem 0; align-items: start;">
    
  <!-- Texto a la izquierda -->
 <div>
        <h3 style="font-size: 1.8rem; font-weight: bold; margin: 1.5rem 0 0.5rem 0;">Why pigeons?</h3>
...
<div style="margin: 2rem 0;">
    <h3 style="font-size: 1.8rem; font-weight: bold; margin: 1.5rem 0 0.5rem 0;">How I contribute</h3>
    <ul style="margin: 0;">
...
<div style="margin: 2rem 0;">
    <h3 style="font-size: 1.8rem; font-weight: bold; margin: 1.5rem 0 0.5rem 0;">Why they need this activation</h3>
...
<div style="margin: 2rem 0;">
    <h3 style="font-size: 1.8rem; font-weight: bold; margin: 1.5rem 0 0.5rem 0;">Collective objectives (not only mine)</h3>
    <ul style="margin: 0;">
