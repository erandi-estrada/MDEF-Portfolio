...
<!-- Slideshow Container -->
<div style="position: relative; max-width: 1200px; margin: 2rem auto 4rem auto; border-radius: 8px; overflow: hidden; box-shadow: 0 5px 25px rgba(0,0,0,0.15);">
...
const slideshowContainer = document.querySelector('[style*="position: relative; max-width: 1200px"]');
