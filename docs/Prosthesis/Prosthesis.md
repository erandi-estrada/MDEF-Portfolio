...
/* Mostrar ojo solo cuando el cursor está en la sección To be judge */
#to-be-judge:hover ~ .eye-follower,
.eye-follower:hover {
    opacity: 1;
}
</style>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('mousemove', function(e) {
        ...
        // Mover el ojo al cursor con un pequeño offset
        eyeContainer.style.left = (e.clientX - 25) + 'px';
        eyeContainer.style.top = (e.clientY - 25) + 'px';
        
        // Mover la pupila dentro del ojo (efecto de seguimiento)
