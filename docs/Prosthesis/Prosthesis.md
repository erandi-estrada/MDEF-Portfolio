...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Script cargado - inicializando ojo seguidor');
    ...
    console.log('Ojo creado y añadido al DOM');
    ...
    if (!toBeJudgeSection) {
        ...
        console.log('Elementos disponibles con id:', document.querySelectorAll('[id]'));
        return;
    }
    
    console.log('Sección "to-be-judge" encontrada');
    ...
    document.addEventListener('mousemove', function(e) {
        if (!eyeContainer.classList.contains('eye-visible')) return;
    ...
    console.log('Ojo seguidor inicializado correctamente');
});
</script>