...
<div class="container">
    ...
    <div class="canvas-card">
        ...
        <hr>
        <div class="canvas-title">TRANSFORMATION & FABLAB INFRASTRUCTURE</div>
        ...
        <strong> Available machines:</strong> Laser cutter, CNC molds, 3D printer (extrusion exp.), heat press. <em>Existing infrastructure enables full local cycle.</em></p>
        <hr>
    ...
    <div class="canvas-card">
        ...
        <aqui quiero una imagen de la matrix>
    ...
    <div class="gallery-grid" id="galleryGrid">
        <!-- aqui solo quiero agregar imagenes y que abajo de cada imagen haya un pequeño texto -->
    </div>
    ...
    <div class="canvas-card">
        <div class="canvas-title">Hybrid experiments</div>
        <div class="grid-2col">
