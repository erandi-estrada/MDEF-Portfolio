...
<div class="diagram-container">
    <div class="hexagon-diagram">
        ...
        <!-- Flechas entre nodos - EN MEDIO DE LOS CÍRCULOS -->
        <!-- Flecha 1-2 (45° diagonal derecha arriba) -->
        <div class="arrow arrow-1-2">
            <div class="arrow-line"></div>
            <div class="arrow-head"></div>
        </div>
        
        <!-- Flecha 2-3 (vertical hacia abajo) -->
        <div class="arrow arrow-2-3">
            <div class="arrow-line"></div>
            <div class="arrow-head"></div>
        </div>
        
        <!-- Flecha 3-4 (45° diagonal izquierda abajo) -->
        <div class="arrow arrow-3-4">
            <div class="arrow-line"></div>
            <div class="arrow-head"></div>
        </div>
        
        <!-- Flecha 4-5 (45° diagonal izquierda arriba) -->
        <div class="arrow arrow-4-5">
            <div class="arrow-line"></div>
            <div class="arrow-head"></div>
        </div>
        
        <!-- Flecha 5-6 (vertical hacia arriba) -->
        <div class="arrow arrow-5-6">
            <div class="arrow-line"></div>
            <div class="arrow-head"></div>
        </div>
        
        <!-- Flecha 6-1 (45° diagonal derecha abajo) -->
...
<style>
    ...
    .arrow {
        position: absolute;
        z-index: 25; /* MAYOR que los círculos (20) */
        display: flex;
        align-items: center;
        justify-content: center;
    }
    ...
    /* Línea de la flecha */
    .arrow-line {
        width: 200px; /* Más larga para estar en medio */
        height: 3px;
        background: #666;
        opacity: 0.7;
        position: relative;
    ...
    .arrow-head {
        ...
        opacity: 0.7;
        right: -10px; /* Se posiciona al final de la línea */
        top: 50%;
        transform: translateY(-50%);
    }
    
    /* POSICIONES CORREGIDAS - EN EL PUNTO MEDIO ENTRE CÍRCULOS */
    
    /* Flecha 1-2: Diagonal 45° derecha arriba */
    .arrow-1-2 {
        /* Punto medio entre nodo 1 y nodo 2 */
        top: calc(15px + 150px + 60px); /* Entre los dos nodos */
        left: calc(900px - 150px + 150px + 60px); /* Entre los dos nodos */
        transform: rotate(60deg); /* 60° para el hexágono */
    }
    
    /* Flecha 2-3: Vertical hacia abajo */
    .arrow-2-3 {
        /* Punto medio entre nodo 2 y nodo 3 */
        top: calc(800px - 275px - 150px + 150px + 75px); /* Entre los dos nodos */
        left: calc(900px + 476px - 150px + 150px); /* Centro horizontal del nodo 2 */
        transform: rotate(90deg);
    }
    
    /* Flecha 3-4: Diagonal 45° izquierda abajo */
    .arrow-3-4 {
        /* Punto medio entre nodo 3 y nodo 4 */
        top: calc(800px + 275px - 150px + 150px - 60px); /* Entre los dos nodos */
        left: calc(900px + 476px - 150px + 150px - 60px); /* Entre los dos nodos */
        transform: rotate(120deg); /* 120° para el hexágono */
    }
    
    /* Flecha 4-5: Diagonal 45° izquierda arriba */
    .arrow-4-5 {
        /* Punto medio entre nodo 4 y nodo 5 */
        top: calc(800px + 550px - 150px + 150px - 60px); /* Entre los dos nodos */
        left: calc(900px - 150px - 60px); /* Entre los dos nodos */
        transform: rotate(180deg); /* 180° para el hexágono */
    }
    
    /* Flecha 5-6: Vertical hacia arriba */
    .arrow-5-6 {
        /* Punto medio entre nodo 5 y nodo 6 */
        top: calc(800px + 275px - 150px + 150px - 75px); /* Entre los dos nodos */
        left: calc(900px - 476px - 150px + 150px); /* Centro horizontal del nodo 5 */
        transform: rotate(270deg); /* 270° = -90° */
    }
    
    /* Flecha 6-1: Diagonal 45° derecha abajo */
    .arrow-6-1 {
        /* Punto medio entre nodo 6 y nodo 1 */
        top: calc(800px - 275px - 150px + 150px + 60px); /* Entre los dos nodos */
        left: calc(900px - 476px - 150px + 150px + 60px); /* Entre los dos nodos */
        transform: rotate(300deg); /* 300° = -60° para el hexágono */
    }
    ...
    .node-position:hover {
        ...
        z-index: 30; /* Mayor que las flechas cuando hay hover */
    }
    ...
    @media (max-width: 2000px) {
        ...
        .arrow-1-2 {
            ...
            left: calc(800px - 150px + 150px + 60px);
        }
        
        .arrow-2-3 {
            top: calc(700px - 250px - 150px + 150px + 75px);
            left: calc(800px + 433px - 150px + 150px);
        }
        
        .arrow-3-4 {
            top: calc(700px + 250px - 150px + 150px - 60px);
            left: calc(800px + 433px - 150px + 150px - 60px);
        }
        
        .arrow-4-5 {
            top: calc(700px + 500px - 150px + 150px - 60px);
            left: calc(800px - 150px - 60px);
        }
        ...
        /* Recalcular posiciones de nodos */
        .node-1 { 
            top: 20px;
    ...
    @media (max-width: 1800px) {
        ...
        .arrow-1-2 {
            ...
            left: calc(700px - 140px + 140px + 60px);
        }
        
        .arrow-2-3 {
            top: calc(600px - 225px - 140px + 140px + 75px);
            left: calc(700px + 390px - 140px + 140px);
        }
        
        .arrow-3-4 {
            top: calc(600px + 225px - 140px + 140px - 60px);
            left: calc(700px + 390px - 140px + 140px - 60px);
        }
        
        .arrow-4-5 {
            top: calc(600px + 450px - 140px + 140px - 60px);
            left: calc(700px - 140px - 60px);
        }
    ...
    @media (max-width: 1600px) {
        ...
        .arrow-1-2 {
            ...
            left: calc(600px - 125px + 125px + 50px);
        }
        
        .arrow-2-3 {
            top: calc(500px - 200px - 125px + 125px + 62.5px);
            left: calc(600px + 346px - 125px + 125px);
        }
        
        .arrow-3-4 {
            top: calc(500px + 200px - 125px + 125px - 50px);
            left: calc(600px + 346px - 125px + 125px - 50px);
        }
        
        .arrow-4-5 {
            top: calc(500px + 400px - 125px + 125px - 50px);
            left: calc(600px - 125px - 50px);
        }
    ...
    /* Responsive adicional (mantener como antes) */
