...
<style>
    ...
    .hover-overlay {
        ...
        transition: all 0.3s ease;
        pointer-events: none;
        mix-blend-mode: multiply; /* Para que se mezcle mejor con la imagen */
    }
    ...
    .node-position:hover .node-img {
        filter: brightness(0.6); /* Reducido para que no sea tan oscuro */
    }
    
    .node-position:hover .hover-overlay {
        opacity: 0.7; /* REDUCIDO DE 0.9 a 0.7 para menos opacidad */
        backdrop-filter: blur(2px); /* Agregado para suavizar */
    }
    ...
    /* Colores específicos para cada overlay - CON MENOS OPACIDAD EN EL COLOR BASE */
    .node-1 .hover-overlay { background-color: rgba(25, 118, 210, 0.8); } /* Antes era #1976d2 */
    .node-2 .hover-overlay { background-color: rgba(56, 142, 60, 0.8); } /* Antes era #388e3c */
    .node-3 .hover-overlay { background-color: rgba(245, 124, 0, 0.8); } /* Antes era #f57c00 */
    .node-4 .hover-overlay { background-color: rgba(211, 47, 47, 0.8); } /* Antes era #d32f2f */
    .node-5 .hover-overlay { background-color: rgba(123, 31, 162, 0.8); } /* Antes era #7b1fa2 */
    .node-6 .hover-overlay { background-color: rgba(0, 121, 107, 0.8); } /* Antes era #00796b */
