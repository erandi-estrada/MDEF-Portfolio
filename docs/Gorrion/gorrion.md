...
<div class="diagram-container">
    <div class="hexagon-diagram">
        ...
        <!-- Flechas entre nodos - CORREGIDAS -->
        <div class="arrow arrow-1-2">
            <div class="arrow-line"></div>
            <div class="arrow-head"></div>
        </div>
        <div class="arrow arrow-2-3">
            <div class="arrow-line"></div>
            <div class="arrow-head"></div>
        </div>
        <div class="arrow arrow-3-4">
            <div class="arrow-line"></div>
            <div class="arrow-head"></div>
        </div>
        <div class="arrow arrow-4-5">
            <div class="arrow-line"></div>
            <div class="arrow-head"></div>
        </div>
        <div class="arrow arrow-5-6">
            <div class="arrow-line"></div>
            <div class="arrow-head"></div>
        </div>
        <div class="arrow arrow-6-1">
            <div class="arrow-line"></div>
            <div class="arrow-head"></div>
        </div>
...
<style>
    ...
    /* Flechas entre nodos - ESTILOS CORREGIDOS */
    .arrow {
        position: absolute;
        z-index: 15; /* Mayor que el z-index de los círculos */
        display: flex;
        align-items: center;
    }
    
    /* Línea de la flecha (la "colita") */
    .arrow-line {
        width: 120px; /* Longitud de la línea */
        height: 4px;
        background: #666;
        opacity: 0.7;
        position: relative;
    ...
    .arrow-head {
        ...
        opacity: 0.7;
        position: relative;
        margin-left: -1px; /* Para que se conecte bien con la línea */
    }
    
    /* Posición y rotación de cada flecha - CORREGIDAS */
    /* Todas las flechas parten del centro de un nodo y apuntan al siguiente */
    
    .arrow-1-2 {
        /* Del nodo 1 al nodo 2 */
        top: calc(15px + 150px); /* Centro vertical del nodo 1 */
        left: calc(900px); /* Centro horizontal del nodo 1 */
        transform: translate(75px, 0) rotate(60deg);
        transform-origin: left center;
    }
    
    .arrow-2-3 {
        /* Del nodo 2 al nodo 3 */
        top: calc(800px - 275px - 150px + 150px); /* Centro vertical del nodo 2 */
        left: calc(900px + 476px - 150px + 150px); /* Centro horizontal del nodo 2 */
        transform: translate(0, 112.5px) rotate(90deg);
        transform-origin: center top;
    }
    
    .arrow-3-4 {
        /* Del nodo 3 al nodo 4 */
        top: calc(800px + 275px - 150px + 150px); /* Centro vertical del nodo 3 */
        left: calc(900px + 476px - 150px + 150px); /* Centro horizontal del nodo 3 */
        transform: translate(-75px, 112.5px) rotate(120deg);
        transform-origin: right center;
    }
    
    .arrow-4-5 {
        /* Del nodo 4 al nodo 5 */
        top: calc(800px + 550px - 150px + 150px); /* Centro vertical del nodo 4 */
        left: calc(900px); /* Centro horizontal del nodo 4 */
    ...
    .arrow-5-6 {
        ...
        top: calc(800px + 275px - 150px + 150px); /* Centro vertical del nodo 5 */
        left: calc(900px - 476px - 150px + 150px); /* Centro horizontal del nodo 5 */
        transform: translate(-75px, -112.5px) rotate(240deg);
        transform-origin: right center;
    }
    
    .arrow-6-1 {
        /* Del nodo 6 al nodo 1 */
        top: calc(800px - 275px - 150px + 150px); /* Centro vertical del nodo 6 */
        left: calc(900px - 476px - 150px + 150px); /* Centro horizontal del nodo 6 */
        transform: translate(0, -112.5px) rotate(270deg);
    ...
    @media (max-width: 2000px) {
        ...
        .arrow-2-3 {
            top: calc(700px - 250px - 150px + 150px);
            left: calc(800px + 433px - 150px + 150px);
            transform: translate(0, 112.5px) rotate(90deg);
        }
        ...
        .arrow-4-5 {
            top: calc(700px + 500px - 150px + 150px);
            left: calc(800px);
            transform: translate(-150px, 0) rotate(180deg);
        }
    ...
    @media (max-width: 1800px) {
        ...
        .arrow-1-2 {
            top: calc(20px + 140px);
            left: calc(700px);
            transform: translate(70px, 0) rotate(60deg);
        }
        
        .arrow-2-3 {
            top: calc(600px - 225px - 140px + 140px);
            left: calc(700px + 390px - 140px + 140px);
        ...
        .arrow-3-4 {
            top: calc(600px + 225px - 140px + 140px);
            left: calc(700px + 390px - 140px + 140px);
            transform: translate(-70px, 105px) rotate(120deg);
        }
        
        .arrow-4-5 {
            top: calc(600px + 450px - 140px + 140px);
            left: calc(700px);
        ...
        .arrow-5-6 {
            top: calc(600px + 225px - 140px + 140px);
            left: calc(700px - 390px - 140px + 140px);
            transform: translate(-70px, -105px) rotate(240deg);
        }
        
        .arrow-6-1 {
            top: calc(600px - 225px - 140px + 140px);
            left: calc(700px - 390px - 140px + 140px);
            transform: translate(0, -105px) rotate(270deg);
        }
    ...
    @media (max-width: 1600px) {
        ...
        .arrow-1-2 {
            top: calc(40px + 125px);
            left: calc(600px);
            transform: translate(62.5px, 0) rotate(60deg);
        }
        
        .arrow-2-3 {
            top: calc(500px - 200px - 125px + 125px);
            left: calc(600px + 346px - 125px + 125px);
            transform: translate(0, 93.75px) rotate(90deg);
        }
        
        .arrow-3-4 {
            top: calc(500px + 200px - 125px + 125px);
            left: calc(600px + 346px - 125px + 125px);
            transform: translate(-62.5px, 93.75px) rotate(120deg);
        }
        
        .arrow-4-5 {
            top: calc(500px + 400px - 125px + 125px);
            left: calc(600px);
            transform: translate(-125px, 0) rotate(180deg);
        }
        
        .arrow-5-6 {
            top: calc(500px + 200px - 125px + 125px);
            left: calc(600px - 346px - 125px + 125px);
            transform: translate(-62.5px, -93.75px) rotate(240deg);
        }
        
        .arrow-6-1 {
            top: calc(500px - 200px - 125px + 125px);
            left: calc(600px - 346px - 125px + 125px);
            transform: translate(0, -93.75px) rotate(270deg);
        }
    ...
    @media (max-width: 1400px) {
        ...
        .arrow-1-2 {
            top: calc(40px + 110px);
            left: calc(500px);
            transform: translate(55px, 0) rotate(60deg);
        }
        
        .arrow-2-3 {
            top: calc(450px - 175px - 110px + 110px);
            left: calc(500px + 303px - 110px + 110px);
            transform: translate(0, 82.5px) rotate(90deg);
        }
        
        .arrow-3-4 {
            top: calc(450px + 175px - 110px + 110px);
            left: calc(500px + 303px - 110px + 110px);
            transform: translate(-55px, 82.5px) rotate(120deg);
        }
        
        .arrow-4-5 {
            top: calc(450px + 350px - 110px + 110px);
            left: calc(500px);
        ...
        .arrow-5-6 {
            top: calc(450px + 175px - 110px + 110px);
            left: calc(500px - 303px - 110px + 110px);
            transform: translate(-55px, -82.5px) rotate(240deg);
        }
        
        .arrow-6-1 {
            top: calc(450px - 175px - 110px + 110px);
            left: calc(500px - 303px - 110px + 110px);
            transform: translate(0, -82.5px) rotate(270deg);
        }
    ...
    @media (max-width: 1200px) {
        ...
        .arrow-2-3 {
            top: calc(400px - 150px - 100px + 100px);
            left: calc(425px + 260px - 100px + 100px);
        ...
        .arrow-3-4 {
            top: calc(400px + 150px - 100px + 100px);
            left: calc(425px + 260px - 100px + 100px);
            transform: translate(-50px, 75px) rotate(120deg);
        }
        
        .arrow-4-5 {
            top: calc(400px + 300px - 100px + 100px);
            left: calc(425px);
        ...
        .arrow-5-6 {
            top: calc(400px + 150px - 100px + 100px);
            left: calc(425px - 260px - 100px + 100px);
            transform: translate(-50px, -75px) rotate(240deg);
        }
    ...
    @media (max-width: 1000px) {
        ...
        .arrow-1-2 {
            top: calc(30px + 90px);
            left: calc(350px);
            transform: translate(45px, 0) rotate(60deg);
        }
        
        .arrow-2-3 {
            top: calc(350px - 125px - 90px + 90px);
            left: calc(350px + 217px - 90px + 90px);
            transform: translate(0, 67.5px) rotate(90deg);
        }
        
        .arrow-3-4 {
            top: calc(350px + 125px - 90px + 90px);
            left: calc(350px + 217px - 90px + 90px);
            transform: translate(-45px, 67.5px) rotate(120deg);
        }
        
        .arrow-4-5 {
            top: calc(350px + 250px - 90px + 90px);
            left: calc(350px);
        ...
        .arrow-5-6 {
            top: calc(350px + 125px - 90px + 90px);
            left: calc(350px - 217px - 90px + 90px);
            transform: translate(-45px, -67.5px) rotate(240deg);
        }
        
        .arrow-6-1 {
            top: calc(350px - 125px - 90px + 90px);
            left: calc(350px - 217px - 90px + 90px);
            transform: translate(0, -67.5px) rotate(270deg);
        }
    ...
    @media (max-width: 850px) {
        ...
        /* Ocultar flechas en pantallas medianas/pequeñas */
        .arrow {
            display: none;
        }
