...
<div class="diagram-container">
    <div class="hexagon-diagram">
        ...
        <div class="hexagon-node node-1" data-node="1">
            <img src="../../Diagrama/1.png" alt="Urban Attractors and Constraints" class="node-img">
        ...
        <div class="hexagon-node node-2" data-node="2">
            <img src="../../Diagrama/2.png" alt="Dietary Poverty & Toxic Intake" class="node-img">
        ...
        <div class="hexagon-node node-3" data-node="3">
            <img src="../../Diagrama/3.png" alt="Chronic Stress and Energetic Drain" class="node-img">
        ...
        <div class="hexagon-node node-4" data-node="4">
            <img src="../../Diagrama/4.png" alt="Impaired Foraging Behavior and Decision-Making" class="node-img">
        ...
        <div class="hexagon-node node-5" data-node="5">
            <img src="../../Diagrama/5.png" alt="Density, Waste, and Compounding Exposure" class="node-img">
        ...
        <div class="hexagon-node node-6" data-node="6">
            <img src="../../Diagrama/6.png" alt="Health Decline Without Escape" class="node-img">
