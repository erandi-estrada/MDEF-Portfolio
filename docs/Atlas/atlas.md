...
<div class="cards-slider-section">
    ...
    <div class="cards-slider-container">
        <div class="cards-slider">
            <!-- Tarjeta 1: Swarming Technobiome -->
            <div class="card-slide active">
                <div class="card-header">
                    <h3>Swarming Technobiome</h3>
                    <span class="card-number">01</span>
                </div>
                <div class="card-content">
                    <p>Swarming Technobiomes imagine infrastructures as living systems composed of distributed bio-technological agents that maintain ecological balance. By prioritizing interspecies wellbeing and restorative justice, they propose care, maintenance, and resource distribution as collective and multispecies responsibilities rather than centralized control.</p>
                </div>
                <div class="card-tags">
                    <span class="tag">Infrastructure</span>
                    <span class="tag">Multispecies</span>
                    <span class="tag">Ecology</span>
                </div>
            </div>
            
            <!-- Tarjeta 2: Inner-City Mini Agro-Parcels -->
            <div class="card-slide">
                <div class="card-header">
                    <h3>Inner-City Mini Agro-Parcels</h3>
                    <span class="card-number">02</span>
                </div>
                <div class="card-content">
                    <p>Inner-city mini agro-parcels introduce micro-ecologies into dense urban environments. These small-scale agricultural spaces create conditions for humans and non-human species to coexist, making climate, soil health, and vulnerability visible and experientially present within everyday city life.</p>
                </div>
                <div class="card-tags">
                    <span class="tag">Urban Ecology</span>
                    <span class="tag">Agriculture</span>
                    <span class="tag">Coexistence</span>
                </div>
            </div>
            
            <!-- Tarjeta 3: Forest Care to Prevent Wildfires -->
            <div class="card-slide">
                <div class="card-header">
                    <h3>Forest Care to Prevent Wildfires</h3>
                    <span class="card-number">03</span>
                </div>
                <div class="card-content">
                    <p>Preventive forest care reframes wildfire management as an ongoing relationship rather than an emergency response. Through maintenance, observation, and ecological stewardship, this approach highlights how climate change intensifies vulnerability and how care practices can be shared across human and non-human systems.</p>
                </div>
                <div class="card-tags">
                    <span class="tag">Prevention</span>
                    <span class="tag">Stewardship</span>
                    <span class="tag">Climate Change</span>
                </div>
            </div>
            
            <!-- Tarjeta 4: Human-Dependent Species -->
            <div class="card-slide">
                <div class="card-header">
                    <h3>Human-Dependent Species</h3>
                    <span class="card-number">04</span>
                </div>
                <div class="card-content">
                    <p>Human-dependent species, such as urban pigeons, exist within ecosystems shaped almost entirely by human activity. As climate and social conditions shift, these species reveal how vulnerability is produced, normalized, and often rejected, challenging humans to confront their responsibility in multispecies survival.</p>
                </div>
                <div class="card-tags">
            ...
            <!-- Tarjeta 5: Loopholes of Care -->
            <div class="card-slide">
                <div class="card-header">
                    <h3>Loopholes of Care</h3>
                    <span class="card-number">05</span>
                </div>
                <div class="card-content">
                    <p>Loopholes of care emerge when survival, maintenance, or ecological repair operate at the edges of legality. These practices reveal how rigid systems fail to account for multispecies needs, and how care-driven actions often precede formal recognition or regulation.</p>
                </div>
                <div class="card-tags">
                    <span class="tag">Adaptation</span>
                    <span class="tag">Informal Systems</span>
        ...
        <div class="slider-controls">
            <button class="slider-btn prev-btn" aria-label="Previous card">
            ...
            <button class="slider-btn next-btn" aria-label="Next card">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<!-- ========================================== -->
<!-- NUEVAS SECCIONES AGREGADAS (SIN MODIFICAR LO ANTERIOR) -->
<!-- ========================================== -->

<!-- STEP 1: 5 Weak Signals (Carrusel de imágenes) -->
<div class="cards-slider-section step-section">
    ...
    <div class="cards-slider-container">
        ...
        <div class="slider-controls">
            <button class="slider-btn prev-btn-step1" aria-label="Previous card">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M15 18l-6-6 6-6"/>
                </svg>
            </button>
            <div class="slider-dots" id="step1Dots">
                <span class="dot active" data-slide="0"></span>
                <span class="dot" data-slide="1"></span>
                <span class="dot" data-slide="2"></span>
                <span class="dot" data-slide="3"></span>
            ...
            <button class="slider-btn next-btn-step1" aria-label="Next card">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M9 18l6-6-6-6"/>
                </svg>
            </button>
...
<!-- STEP 2: Dos columnas (Random Triggers y New Opportunities) -->
<div class="step2-container">
    <h2 class="cards-slider-title">Step 2: Mapping Connections</h2>
    <div class="two-columns-step2">
        <!-- Columna izquierda: Random Triggers -->
        <div class="step2-col">
            ...
            <div class="cards-slider-container mini-slider">
                ...
                <div class="slider-controls mini-controls">
                    <button class="slider-btn prev-btn-triggers" aria-label="Previous">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M15 18l-6-6 6-6"/>
                        </svg>
                    </button>
                    <div class="slider-dots" id="triggersDots">
                        <span class="dot active" data-slide="0"></span>
                        <span class="dot" data-slide="1"></span>
                        <span class="dot" data-slide="2"></span>
                        <span class="dot" data-slide="3"></span>
                    ...
                    <button class="slider-btn next-btn-triggers" aria-label="Next">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M9 18l6-6-6-6"/>
                        </svg>
                    </button>
        ...
        <!-- Columna derecha: New Opportunities -->
        <div class="step2-col">
            ...
            <div class="cards-slider-container mini-slider">
                ...
                <div class="slider-controls mini-controls">
                    <button class="slider-btn prev-btn-opportunities" aria-label="Previous">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M15 18l-6-6 6-6"/>
                        </svg>
                    </button>
                    <div class="slider-dots" id="opportunitiesDots">
                        <span class="dot active" data-slide="0"></span>
                        <span class="dot" data-slide="1"></span>
                        <span class="dot" data-slide="2"></span>
                        <span class="dot" data-slide="3"></span>
                    ...
                    <button class="slider-btn next-btn-opportunities" aria-label="Next">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M9 18l6-6-6-6"/>
                        </svg>
                    </button>
...
<!-- STEP 3: 5 Secondary Weak Signals -->
<div class="cards-slider-section step-section">
    ...
    <div class="cards-slider-container">
        ...
        <div class="slider-controls">
            <button class="slider-btn prev-btn-step3" aria-label="Previous card">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M15 18l-6-6 6-6"/>
                </svg>
            </button>
            <div class="slider-dots" id="step3Dots">
                <span class="dot active" data-slide="0"></span>
                <span class="dot" data-slide="1"></span>
                <span class="dot" data-slide="2"></span>
                <span class="dot" data-slide="3"></span>
            ...
            <button class="slider-btn next-btn-step3" aria-label="Next card">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M9 18l6-6-6-6"/>
                </svg>
            </button>
...
<div class="step4-container">
    <h2 class="cards-slider-title">Step 4: CoP</h2>
    <div class="cop-text">
        <p>Community of Practice: Urban planners and architects</p>
    </div>
    <div class="cop-image">
        <img src="../../images/atlas/21.jpg" alt="CoP Image" class="cop-main-image">
    </div>
    <div class="two-column-cop">
        <div class="cop-column-left">
            <img src="../../images/atlas/22.jpg" alt="Bio-integrated architecture" class="cop-side-image">
        </div>
        <div class="cop-column-right">
            <p class="cop-description">Through bio-integrated architecture and living wall systems, facades become habitats that support insects, birds, and plant life, transforming buildings into vertical ecosystems.</p>
        </div>
    </div>
</div>
...
<!-- Estilos para el diagrama horizontal -->
<style>
/* Contenedor del diagrama horizontal */
...
/* Líneas de conexión desde cada concepto al Kit (solo visible en desktop) */
.concept-box {
    position: relative;
}
...
@media (max-width: 1100px) {
    ...
    /* Mostrar líneas de conexión en móvil */
    .concept-box::after {
        display: block;
    }
}
...
.mini-slider .images-slider {
    height: 300px;
}

.mini-controls .slider-btn {
    width: 40px;
    height: 40px;
}
...
<script>
// JavaScript para el carrusel de tarjetas (original)
...
// Función genérica para inicializar carruseles de imágenes
function initImageSlider(sliderId, prevBtnClass, nextBtnClass, dotsId) {
    const slides = document.querySelectorAll(`#${sliderId} .card-slide-image`);
    ...
    // Auto-avance
    let interval = setInterval(() => showSlide(currentSlide + 1), 8000);
    
    const container = document.querySelector(`#${sliderId}`).closest('.cards-slider-container');
    if (container) {
        container.addEventListener('mouseenter', () => clearInterval(interval));
        container.addEventListener('mouseleave', () => {
            interval = setInterval(() => showSlide(currentSlide + 1), 8000);
        });
    }
...
// Inicializar todos los carruseles de imágenes cuando el DOM esté listo
document.addEventListener('DOMContentLoaded', function() {
    // Step 1 slider
    initImageSlider('step1Slider', 'prev-btn-step1', 'next-btn-step1', 'step1Dots');
    // Step 3 slider
    initImageSlider('step3Slider', 'prev-btn-step3', 'next-btn-step3', 'step3Dots');
    // Triggers slider
    initImageSlider('triggersSlider', 'prev-btn-triggers', 'next-btn-triggers', 'triggersDots');
    // Opportunities slider
    initImageSlider('opportunitiesSlider', 'prev-btn-opportunities', 'next-btn-opportunities', 'opportunitiesDots');
});
</script>