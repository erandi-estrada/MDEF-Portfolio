...
<!-- Diagrama sencillo sin fondo -->
<div class="simple-diagram-container">
    <h2 class="simple-diagram-title">Post-Capitalist Care Framework</h2>
    
    <div class="simple-diagram">
        <!-- Nodo central -->
        <div class="simple-central-node">
        ...
        <div class="simple-branch branch-1">
            <div class="branch-content">
                <h4>Tech Abolition</h4>
                <p class="branch-desc">Rethinking technology beyond capitalist paradigms</p>
            </div>
            <div class="connector-to-kit"></div>
            <div class="kit-box">Kit</div>
        </div>
        
        <!-- Rama 2: Border Regimes -->
        <div class="simple-branch branch-2">
            <div class="branch-content">
                <h4>Border Regimes</h4>
                <p class="branch-desc">Challenging territorial and social boundaries</p>
            </div>
            <div class="connector-to-kit"></div>
            <div class="kit-box">Kit</div>
        </div>
        ...
        <div class="simple-branch branch-3">
            <div class="branch-content">
                <h4>Boredom and Laziness</h4>
                <p class="branch-desc">Reclaiming time and resisting productivity culture</p>
            </div>
            <div class="connector-to-kit"></div>
            <div class="kit-box">Kit</div>
        </div>
...
<!-- Estilos para el diagrama sencillo -->
<style>
/* Contenedor del diagrama sencillo */
...
/* Conectores desde el nodo central */
.connector {
    position: absolute;
    background: #1976d2;
    z-index: 1;
...
/* Posicionamiento de las ramas */
.branch-1 {
    /* Tech Abolition - Derecha */
    top: 50%;
    left: calc(50% + 220px);
    transform: translateY(-50%);
}
